        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Link to="/lich-dat" className="text-sm font-bold text-[#60D86E] hover:underline">Xem tất cả</Link>
            </div>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center shadow-sm">
                ...
                <Link to="/dat-san" className="mt-4 inline-block text-sm font-bold text-white bg-[#60D86E] px-5 py-2.5 rounded-full hover:bg-[#45c45a] transition-colors">
                  Tìm sân ngay
                </Link>
              </div>
            ) : (
                ...
                {upcomingBookings.map(booking => {
                  ...
                  return (
                    <div 
                      ...
                      onClick={() => navigate(`/lich-dat/${booking.bookingId || booking.id}`, { state: { booking } })}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <Link to="/dat-san" className="bg-[#1a202c] text-white rounded-2xl p-4 flex items-center justify-between hover:bg-[#2d3748] transition-colors">
              ...
              <Link to="/lich-dat" className="bg-white border border-gray-100 text-[#1a202c] rounded-2xl p-4 flex items-center justify-between hover:border-[#60D86E] hover:text-[#60D86E] transition-colors shadow-sm">
                <div className="flex items-center gap-3">
